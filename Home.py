...
# Maps
st.map(df)
st.write('for mapping references checkout [deckgl](https://deckgl.readthedocs.io/en/latest/) or [pydeck](https://docs.streamlit.io/library/api-reference/charts/st.pydeck_chart)')
...
# sidebar comment
slider_choice = st.sidebar.selectbox('You can variious options',['yes','no'])
